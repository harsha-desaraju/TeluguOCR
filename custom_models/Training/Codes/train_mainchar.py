...
Y_train = np_utils.to_categorical(dataset[u'Y_c_train'],num_classes=57)
print(len(X_train))
print(X_train.shape)
...
Y_val = np_utils.to_categorical(dataset[u'Y_c_val'],num_classes=57)
...
with open('model_mainchar.json','w') as outfile:
  json.dump(json_txt,outfile)
  outfile.close()

model.save_weights("model_mainchar.hdf5")