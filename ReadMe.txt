...
Run the OCR.ipynb file in google colab with hardware accelerator
as GPU (for running smoothly)
...
Training folder contains the codes for training of the models and the
model outputs.
